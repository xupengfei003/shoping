...
import static com.sao.so.supplier.service.crypto.cipher.RsaTestKeyData.D;
import static com.sao.so.supplier.service.crypto.cipher.RsaTestKeyData.E;
import static com.sao.so.supplier.service.crypto.cipher.RsaTestKeyData.N;
...
public class JwtTests {
    ...
    public void inspectCustomHeaders() throws Exception {
        ...
        System.out.println(JwtHelper.encode(JOE_CLAIM_SEGMENT, hmac, Collections.singletonMap("foo", "bar")).getEncoded());
    ...
    public void inspectHeaders() throws Exception {
        ...
        System.out.println(JwtHelper.decode(JOE_RSA_TOKEN).getClaims());
