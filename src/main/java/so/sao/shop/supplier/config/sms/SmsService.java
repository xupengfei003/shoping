...
public class SmsService {
     ...
     */
    public SendSmsResponse sendSms(String phoneNumbers, String code) throws ClientException, IOException {
        //设置超时时间-可自行调整
        ...
        DefaultProfile.addEndpoint(properties.getEndpointName(), properties.getRegionId(), product, domain);
        ...
        request.setTemplateParam("{\"code\":\"" + code + "\", \"product\":\"透云平台\"}");

        //可选-上行短信扩展码(无特殊需求用户请忽略此字段)
        //request.setSmsUpExtendCode("90997");
        //可选:outId为提供给业务方扩展字段,最终在短信回执消息中将此值带回给调用者
//        request.setOutId(properties.getOutId());
