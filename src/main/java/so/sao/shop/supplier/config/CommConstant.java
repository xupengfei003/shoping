...
/*            case Constant.COMM_ST_FC:
     ...
     *
     */
    public static final String[] EXCEL_TITLES ={"序号","*商品条码","商品商家编码","*商品名称","*商品图片（1-10张）","*品牌","*商品分类一级","*商品分类二级","*商品分类三级","*产地","*库存单位","*规格单位","*规格","*箱规","*透云供货价","*app订货价","*生产日期","*有效期(天)","*最小起订量","*企业名称","供应商id","商品标签","*商品简介"};
     ...
     *
     */
    public static final String[] EXCEL_OUT_TITLES ={"序号","*商品条码","商品商家编码","*商品名称","*商品图片（1-10张）","*品牌","*商品分类一级","*商品分类二级","*商品分类三级","*产地","*库存单位","*规格单位","*规格","*箱规","*透云供货价","*app订货价","*生产日期","*有效期(天)","*最小起订量","*企业名称","供应商id","商品标签","*商品简介"};
