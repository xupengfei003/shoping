...
/*            case Constant.COMM_ST_FC:
     ...
     *
     */
    public static final String[] EXCEL_TITLES ={"序号","*商品条码","商品商家编码","*商品名称","*商品图片（1-10张）","*商品品牌","*商品分类一级","*商品分类二级","*商品分类三级","*商品产地","*库存单位","*规格单位","*规格","*箱规","*透云进货价","*app订货价","*生产日期","*有效期(天)","*起订量","*企业名称","供应商id","商品标签","*商品说明"};
     ...
     *
     */
    public static final String[] EXCEL_OUT_TITLES ={"序号","*商品条码","商品商家编码","*商品名称","*商品图片（1-10张）","*商品品牌","*商品分类一级","*商品分类二级","*商品分类三级","*商品产地","*库存单位","*规格单位","*规格","*箱规","*透云进货价","*app订货价","*生产日期","*有效期(天)","*起订量","*企业名称","供应商id","商品标签","*商品说明"};
