...
public class CommodityController {
    ...
    public PageInfo search(HttpServletRequest request,  Long supplierId,@RequestParam(required = false) String commCode69,@RequestParam(required = false) Long commId,
