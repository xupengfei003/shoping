...
public class ZipUtil {
	 ...
	 */
	private static void unrar(String sourceRar, String destDir ,Boolean isDelete)throws Exception {
		Archive a = null;
	 ...
	 * 解压缩
	 */
	public static void deCompress(String sourceFile, String destDir ,Boolean isDelete)throws Exception {
		// 保证文件夹路径最后是"/"或者"\"
