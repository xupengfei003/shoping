...
import com.sao.so.supplier.dao.*;
import com.sao.so.supplier.domain.*;
...
import com.sao.so.supplier.pojo.vo.*;
import com.sao.so.supplier.service.CommodityService;
import com.sao.so.supplier.util.BaseResultUtil;
import com.sao.so.supplier.util.Constant;
import com.sao.so.supplier.util.ExcelReader;
import com.sao.so.supplier.util.PageUtil;
...
public class CommodityServiceImpl implements CommodityService {
    ...
    public BaseResult saveCommodity(HttpServletRequest request,CommodityInput commodityInput) {
        ...
        result.setCode(com.sao.so.supplier.config.Constant.CodeConfig.CODE_SUCCESS);
    ...
    public BaseResult deleteCommodities(Long[] ids) {
        ...
        if(null != idNotList && idNotList.size() > 0){
            baseResult.setCode(com.sao.so.supplier.config.Constant.CodeConfig.CODE_FAILURE);
            baseResult.setMessage("商品需下架才可删除,id:"+idNotList);
            return baseResult;
        }
        baseResult.setCode(com.sao.so.supplier.config.Constant.CodeConfig.CODE_SUCCESS);
