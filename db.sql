...
CREATE TABLE `receipt_user` (
  ...
  `taxpayer_number` bigint(256) NOT NULL COMMENT '纳税人识别号',
  ...
  `bank_amount` varchar(256) DEFAULT NULL COMMENT '银行账户',
...
CREATE TABLE `receipt_purchase` (
  ...
  `taxpayer_number` bigint(256) DEFAULT NULL COMMENT '纳税人识别号',
  `receipt_content_id` bigint(20) DEFAULT NULL COMMENT '发票内容id',
  `receipt_content` varchar(20) DEFAULT NULL COMMENT '发票内容',
  `register_adress` varchar(150) DEFAULT NULL COMMENT '注册地址',
  `register_phone` varchar(256) DEFAULT NULL COMMENT '注册电话',
  `deposit_bank` varchar(256) DEFAULT NULL COMMENT '开户银行',
  `bank_amount` varchar(256) DEFAULT NULL COMMENT '银行账户',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
